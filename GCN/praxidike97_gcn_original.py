# Classification original code (NO PARALLELISM)
...
def train(data, plot=False):
    ...
    if plot: 
        ...
        plt.savefig("AUC_praxidike97_gcn_original.png")
...
if __name__ == "__main__":
    ...
    model = Net(dataset).to(device) # send model to device
    optimizer = torch.optim.Adam(model.parameters(), lr=0.01, weight_decay=5e-4) # optimizer

    train(data, plot=True) # train the model